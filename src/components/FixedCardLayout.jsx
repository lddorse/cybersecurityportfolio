const FixedCardLayout = ({ children }) => {
  return (
    <div className="relative min-h-screen w-full bg-gray-200">
      {/* Top Fade Overlay */}
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-gray-200/95 to-transparent z-30 pointer-events-none" />
      ...
      <div
        className="
          ...
          w-full
          h-[calc(100vh-5rem)]
          bg-white shadow-xl z-20 border-t border-gray-300 overflow-y-auto
