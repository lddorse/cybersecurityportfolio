...
const ProjectCategories = () => {
  const featuredProjects = [
    {
      name: 'Elo Sec Platform',
      path: '/projects/elosec-platform',
      description: 'Self-hosted network security & infrastructure monitoring platform running on Raspberry Pi 4. Blocks 1,500+ weekly intrusion attempts using Pi-hole, WireGuard VPN, Grafana monitoring, and automated threat detection.',
      tech: 'Pi-hole • WireGuard • Grafana • Docker • Nginx',
      link: 'https://elosec.tech',
      status: 'https://status.leodorsey.com'
    }
  ];
      ...
      <div className="mb-12">
        ...
        <div className="max-w-4xl mx-auto">
          {featuredProjects.map((project, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg rounded-lg p-8 border-2 border-blue-200"
            >
              <h3 className="text-2xl font-bold text-blue-900 mb-3">{project.name}</h3>
