...
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Technical Architecture</h2>
  
  {/* Defense in Depth Diagram */}
  <div className="bg-gray-100 dark:bg-gray-700 p-6 rounded-lg mb-6 border border-gray-200 dark:border-gray-600">
    <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Security Architecture: Defense in Depth</h3>
...
{`Internet → Firewall (UFW) → Intrusion Prevention (Fail2ban) → Network Services
  ...
  <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow mb-6 border border-gray-200 dark:border-gray-600">
    <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Infrastructure Foundation</h3>
    <div className="mb-4">
      <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Hardware:</h4>
    ...
    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded border border-gray-200 dark:border-gray-600">
      <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Why Raspberry Pi?</h4>
      <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
  ...
  <div className="space-y-6">
    <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Core Security Components</h3>
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      ...
      <div className="mb-4">
        <img 
          ...
          className="rounded-lg shadow-lg w-full border border-gray-300 dark:border-gray-600"
        />
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Pi-hole dashboard showing 79,811 domains on blocklists</p>
      </div>

      <div className="grid md:grid-cols-2 gap-4 mb-3">
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Current Statistics:</p>
        ...
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Security Benefits:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      ...
      <div className="mb-4">
        <img 
          ...
          className="rounded-lg shadow-lg w-full border border-gray-300 dark:border-gray-600"
        />
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">WireGuard admin interface</p>
      </div>

      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Cryptographic Implementation:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
        ...
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Why WireGuard?</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-600 p-4 mb-3">
        <p className="font-semibold text-yellow-900 dark:text-yellow-300">Active Protection:</p>
        <p className="text-gray-700 dark:text-gray-300">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Active Jails:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
...
{/* Monitoring Stack */}
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Monitoring & Observability Stack</h2>
  <div className="space-y-6">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-3">
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Data Sources:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
        ...
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Monitored Metrics:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded border border-gray-200 dark:border-gray-600">
        <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Monitored Services:</p>
...
{/* Web Services */}
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Web Services & Infrastructure</h2>
  <div className="space-y-6">
    
    {/* Nginx */}
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">Nginx: Reverse Proxy & TLS Termination</h4>
      <p className="text-gray-700 dark:text-gray-300 mb-3">
        High-performance web server handling all HTTP/HTTPS traffic, routing requests to appropriate backend services
      </p>
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Security Configuration:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
        ...
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Proxied Services:</p>
          <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    {/* Let's Encrypt */}
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">Let's Encrypt: Automated Certificate Management</h4>
      <p className="text-gray-700 dark:text-gray-300 mb-3">
...
{/* Current Metrics */}
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Current Performance Metrics</h2>
  <div className="grid md:grid-cols-3 gap-4">
    <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 dark:border-green-600 p-4">
      <p className="text-2xl font-bold text-green-700 dark:text-green-400">1,518</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Blocked intrusions (last 7 days)</p>
    </div>
    <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-600 p-4">
      <p className="text-2xl font-bold text-blue-700 dark:text-blue-400">79,811</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Domains on blocklists</p>
    </div>
    <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-500 dark:border-purple-600 p-4">
      <p className="text-2xl font-bold text-purple-700 dark:text-purple-400">99.38%</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Pi-hole uptime</p>
    </div>
    <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-600 p-4">
      <p className="text-2xl font-bold text-yellow-700 dark:text-yellow-400">26</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Running containers</p>
    </div>
    <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-600 p-4">
      <p className="text-2xl font-bold text-red-700 dark:text-red-400">21.2%</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Memory usage</p>
    </div>
    <div className="bg-indigo-50 dark:bg-indigo-900/20 border-l-4 border-indigo-500 dark:border-indigo-600 p-4">
      <p className="text-2xl font-bold text-indigo-700 dark:text-indigo-400">3-5W</p>
      <p className="text-sm text-gray-700 dark:text-gray-300">Power consumption</p>
    </div>
  </div>
</section>
...
<section className="mb-8">
  ...
  <div className="grid md:grid-cols-3 gap-6">
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      <h3 className="text-lg font-semibold mb-3 text-blue-700 dark:text-blue-400">Cybersecurity & Risk Management</h3>
      <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      <h3 className="text-lg font-semibold mb-3 text-green-700 dark:text-green-400">DevOps & Infrastructure</h3>
      <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
      <h3 className="text-lg font-semibold mb-3 text-purple-700 dark:text-purple-400">Networking & Protocols</h3>
      <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
...
{/* Lessons Learned */}
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Lessons Learned & Challenges Overcome</h2>
  <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
    <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Technical Challenges:</h3>
    <div className="space-y-4">
      <div>
        <p className="font-semibold text-gray-800 dark:text-gray-200">1. Resource Optimization</p>
      ...
      <div>
        <p className="font-semibold text-gray-800 dark:text-gray-200">2. DNS Complexity</p>
        <p className="text-sm text-gray-700 dark:text-gray-300">
      ...
      <div>
        <p className="font-semibold text-gray-800 dark:text-gray-200">3. Certificate Automation</p>
        <p className="text-sm text-gray-700 dark:text-gray-300">
    ...
    <h3 className="text-lg font-semibold mb-3 mt-6 text-gray-900 dark:text-gray-100">Best Practices Adopted:</h3>
    <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
...
{/* Future Enhancements */}
<section className="mb-8">
  <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Planned Enhancements</h2>
  <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-600">
    <div className="grid md:grid-cols-2 gap-6">
      <div>
        <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Short-Term (Next 3 Months):</h3>
      ...
      <div>
        <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Medium-Term (3-6 Months):</h3>
        <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-2">
...
<section className="mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-8 rounded-lg border-2 border-blue-200 dark:border-blue-700">
  ...
  <p className="text-gray-700 dark:text-gray-300 mb-4">This project demonstrates:</p>
