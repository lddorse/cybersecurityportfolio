...
<FixedCardLayout>                    <BackButton />
      <h1 className="text-3xl font-bold mb-4 dark:text-gray-100">Red Team / Blue Team Lab Projects</h1>
        ...
        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 shadow mt-6 border border-gray-200 dark:border-gray-600">
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Red Team / Blue Team Simulation</h2>
        ...
        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 shadow mt-6 border border-gray-200 dark:border-gray-600">
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">MITRE ATT&CK Mapping & Detection Validation</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
