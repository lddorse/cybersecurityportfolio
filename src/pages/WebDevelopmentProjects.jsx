    ...
    <FixedCardLayout>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="flex gap-2">
          <a href="https://sacred-prints.com" target="_blank" rel="noopener noreferrer" className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
            Live Site
          </a>
          <Link to="/projects/sacred-prints" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
            View Details
          </Link>
        </div>
      </div>
